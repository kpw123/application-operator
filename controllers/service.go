...
func (r *ApplicationReconciler) reconcileService(ctx context.Context, app *appsv1.Application) (result ctrl.Result, err error) {
	...
	if err == nil {
		...
		log.Info("The network status has been updated.")
		return ctrl.Result{}, nil
	}
